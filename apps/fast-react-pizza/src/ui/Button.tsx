...
function Button({
  ...
  const styles = {
    [ButtonType.primary]: base + " px-4 py-3 md:px-6 md:py-4",
    [ButtonType.small]: base + " px-4 py-2 md:px-5 md:py-2.5 text-xs",
    [ButtonType.round]: base + " px-2.5 py-1 md:px-3.5 md:py-2 text-sm",
